            ...
            <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-sm-5 order-1">
                            <div className="widget site-info-widget">
                                ...
                                <p>GLOBAL SERVICES AND PRINTING is a multidimensional company that wields great competence and expertise.</p>
                                        ...
                                        <ul className="contact-infos">
                                            <li>
                                                <Link to="tel:+0123456789">
                                                    ...
                                                    +237-674-629 / 242-721-707 
                    </Link>
                                            </li>
                                            <li>
                                                <Link to="mailto:support@gmail.com">
                                                    <i className="far fa-envelope-open" />
                                                    globalservicesandprinting@gmail.com 
                    </Link>
                                            </li>
                ...
                <div className="footer-copyright">
                    <p className="copyright-text">
                        <span>@<Link to="#">Global Services & Provider</Link>.-2021</span>
                        <span>All Right Reserved Design By Mercury-Tech</span>
                    </p>
