...
const bannerslide = [
    { img: img1, title: "A better society is a healthy society", text: 'We enforce the fight against COVID 19 as well as making sure that we /n provide maximum support to orphans.', btntext: 'Get it Now', btntext1: 'Our Services' },
    { img: img2, title: "Education for all with GSP", text: 'Online classes on the global scope for all, we make sure that you learn from wherever you are /n in the world with no limitations.', btntext: 'Get it Now', btntext1: 'Our Services' },
    ...
    { img: img6, title: "we print at your demand", text: ': If you think of it, we print it for you. We put at your disposal high-quality print for all your varying needs ranging from the printing /n of textbooks, calendars, exercise books, posters etc…. as well as editing', btntext: 'Get it Now', btntext1: 'Our Services' },
]
